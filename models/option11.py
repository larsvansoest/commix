...
class Option11(AbstractModel):
    ...
    def __init__(self, embedding_size, nonlinearity, dropout_rate, transforms):
        super(Option11, self).__init__(embedding_size)
    ...
    def create_architecture(self):
        ...
        self._architecture_normalized = super(
            Option11,self).l2_normalization_layer(self._architecture,1)
    ...
    def weight(self, reg_uv, W, V, Wb, Vb, _batchsize):
        ...
        weighted_V_W_uv_opt2 = tf.einsum('bmn,mno->bm', weighted_W_uv_opt2_bias, V)
